# Generated by Powerlevel10k configuration wizard on 2025-12-03 at 11:51 CST.
...
# dotted, left frame, lightest-ornaments, compact, many icons, concise,
...
prompt_jujutsu() {
  ...
  p10k segment -f "$color" -t "$description"
}
