...
hl.bind("CTRL + SHIFT + ALT + A", hl.dsp.exec_cmd(mxbin .. "flameshot-full"), { allow_input_capture = true, locked = true })
hl.bind("CTRL + ALT + A", hl.dsp.exec_cmd(mxbin .. "flameshot-gui"), { allow_input_capture = true, locked = true })
